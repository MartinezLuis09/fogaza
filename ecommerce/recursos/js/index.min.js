$("#btnGridList").click(function () {
  ...
  $(".gridProduct").click(function () {
    let a = $(this).attr("identificador"),
      b = $(this).attr("name"),
      c = $(this).attr("precio");
    localStorage.setItem("idProducto", a),
      localStorage.setItem("nameProducto", b),
      localStorage.setItem("precio", c),
      setInterval(() => {
  ...
  $("#iptBusqueda").keydown(function (a) {
    if (13 == a.which) {
      if ($("#iptBusqueda").val()) {
        let b = $(this).val();
        sessionStorage.setItem("productoBuscado", b),
          (window.location.href = "buscador.html");
      } else
        $("#iptBusqueda").focus(), $("#iptBusqueda").addClass("is-invalid");
      a.preventDefault();
    }
  }),
  $(".btnBusqueda").click(function () {
    if ($("#iptBusqueda").val()) {
      let a = $(this).val();
      sessionStorage.setItem("productoBuscado", a),
        (window.location.href = "buscador.html");
    } else $("#iptBusqueda").focus(), $("#iptBusqueda").addClass("is-invalid");
  });
