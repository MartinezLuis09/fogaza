                            ...
                            <div class="row">
                                ...
                                <div class="card-text col-8 col-sm-8 col-md-8 col-lg-4 col-xl-5">
                                    ...
                                    <p class="text-muted m-0 ellipsis-2">Lorem ipsum dolor sit amet consectetur
                                        adipisicing
                                        elit. Consequatur tempore maiores possimus ipsum, nulla quae esse corporis
                                        voluptate
                                        fuga laboriosam numquam dolor perspiciatis minus et totam facere veritatis.
                                        Numquam,
                                        nihil?</p>
                                </div>
                                    ...
                                    <!-- <div class="col-12 col-sm-3">
                                        <div class="form-floating ">
                                            <select id="ordenarModal" class="form-select form-select-sm" placeholder="Seleccionar Orden">
                                                <option selected value="Seleccionar Orden" disabled>Seleccionar Orden
                                                </option>
                                            ...
                                            <label for="ordenarModal" aria-label="Ordenar Por"><i class="icon-sort-alt-down"></i>
                                                Ordenar Por</label>
                                        </div>
                                    </div> -->
                                </div>
