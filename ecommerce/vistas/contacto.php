                    ...
                    <div class="row g-0">
                        <div class="col-md-8">
                            <div class="card-body">
                                ...
                                <div class="card-text">
                                    <button class="btn btn-danger col-12" aria-label="Enviar mensaje"><i
                                            class="icon-mail"></i> Enviar mensaje</button>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 p-2">
                            ...
                            <div class="col-12 text-center">
                                <a class="txt-none" aria-label="Facebook" href="https://www.facebook.com/LaFogaza"
                                    target="_blank" data-bs-toggle="tooltip" data-bs-toggle="tooltip"
                                    data-bs-placement="top" data-bs-title="Tooltip on top">
                                    <i class="fs-2 text-primary icon-facebook-1"></i>
                                </a>
                                <a class="txt-none" aria-label="Instagram"
                                    href="https://www.instagram.com/LaFogaza.tap/" target="_blank">
                                    <i class="fs-2 text-danger icon-instagram"></i>
                                </a>
                                <a class="txt-none" aria-label="Whatsapp" href="https://wa.me/+529621531832"
                                    target="_blank">
                            ...
                            <div class="col-12 text-center">
                                ...
                                <div id="tooltip" role="tooltip"
                                    style="position: absolute; inset: auto auto 0px 0px; margin: 0px; transform: translate(127px, -347px);"
                                ...
                                <div class="col-12 text-center mt-2">
                                    <a class="txt-none text-muted fs-5" href="tel:+529621531832"><i
                                            class="icon-phone-1"></i> 962 153 18 32
                                    </a>
                                </div>
                                ...
                                <div class="col-12 text-center mt-2">
                                    <a class="txt-none text-muted" href="https://g.page/LaFogaza?share"
                                        target="_blank"><i class="icon-location-1"></i> 4a Av. Norte entre Central y 1a
                                        Poniente.
                                        Tapachula, Chiapas</a>
                                    <iframe
                                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3855.5251687446057!2d-92.2673708856765!3d14.907806573472065!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x858e0f20fb86779d%3A0x1d948a7d3a6eef09!2sLa%20Fogaza!5e0!3m2!1ses-419!2smx!4v1659239627424!5m2!1ses-419!2smx"
